...
<aside class="main-sidebar">
	...
	<section class="sidebar">
		...
		<ul class="sidebar-menu">
			...
			<li class="<?php trv_state('home', $url1, $url2);?>"><a href="<?php echo site_url("pokja/home")?>"><i class="fa fa-home"></i> <span>home</span></a></li>
			<li class="treeview <?php trv_state('gedung', $url1, $url2);?>">
				<a href="#"><i class="fa fa-building"></i> <span>Data Inspeksi</span>
					<span class="pull-right-container">
						<i class="fa fa-angle-left pull-right"></i>
					</span>
				</a>
				<ul class="treeview-menu">
					<li><a href="<?php echo site_url("disposisi/list_gedung")?>">Buat Laporan</a></li>
					<li><a href="<?php echo site_url("disposisi/add_gedung")?>"></a></li>
				</ul>
			</li>
