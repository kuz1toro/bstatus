...
<body class="theme-red">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            ...
            <div class=" collapse navbar-collapse " id="navbar-collapse" >
                <a class="nav navbar-nav navbar-right" href="<?php echo site_url("auth/logout")?>" style="padding: 20px 7px"><i class="material-icons">logout</i></a>
            </div>
        </div>
    </nav>
    <!-- #Top Bar -->
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="image">
                    <img src="<?php echo base_url(); ?>assets/vendor/admin_lte/img/damkar.png" width="48" height="48" alt="User" />
                </div>
